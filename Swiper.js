...
import { PanResponder, Dimensions, Text, View, Animated } from 'react-native'
...
class Swiper extends Component {
    ...
    initializeCardStyle = () => {
        ...
        const cardWidth = this.state.width - cardHorizontalMargin * 2
        const cardHeight = this.state.height - cardVerticalMargin * 2 - marginTop - marginBottom
...
Swiper.defaultProps = {
    ...
    horizontalThreshold: screenSize.width / 4,
    infinite: false,
    inputCardOpacityRangeX: [-screenSize.width / 2, -screenSize.width / 3, 0, screenSize.width / 3, screenSize.width / 2],
    inputCardOpacityRangeY: [-screenSize.height / 2, -screenSize.height / 3, 0, screenSize.height / 3, screenSize.height / 2],
    ...
    inputRotationRange: [-screenSize.width / 2, 0, screenSize.width / 2],
    marginBottom: 0,
    marginTop: 0,
    onSwiped: cardIndex => {
    ...
    overlayOpacityHorizontalThreshold: screenSize.width / 4,
    overlayOpacityVerticalThreshold: screenSize.height / 5,
    previousCardInitialPositionX: 0,
    previousCardInitialPositionY: -screenSize.height,
    secondCardZoom: 0.97,
    showSecondCard: true,
    style: null,
    ...
    verticalSwipe: true,
    verticalThreshold: screenSize.height / 5,
